...
// создаем функцию, которая ищет самое большое число в массиве
...
var numbers1 = [5, 8, 2, 10, 3];
var numbers2 = [15, 25, 5, 30, 12];
var numbers3 = [100, 50, 70, 20, 10];

console.log("Максимальное значение в первом массиве:", findMax(numbers1));
console.log("Максимальное значение во втором массиве:", findMax(numbers2));
console.log("Максимальное значение в третьем массиве:", findMax(numbers3));
